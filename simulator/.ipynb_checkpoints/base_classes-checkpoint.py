...
class Body(object):
    ...
    def add_trajectory(self, data):
        ...
        self._num_timesteps = data.shape[0]
...
class StarSystem(object):
    ...
    #In theory we should have the data such that each Body in the StarSystem should have 
    def set_num_timesteps(self):
        self._num_timesteps = min(body.get_num_timesteps() for body in self._bodies)
